            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <h3 class="mb-3">Регистрация на сайте</h3>
                        <div class="bg-white shadow rounded">
                            <div class="row">
                                <div class="col-md-7 pe-0">
                                    <div class="form-left h-100 py-5 px-5">
                                        <form action="vendor/register_process.php" class="row g-4" method="post">
                                            <div class="col-12">
                                            ...
                                            <div class="col-sm-6">
                                                <a href="login.php" class="float-end text-primary">Если есть аккаунт войдите!</a>
                                            </div>

                                            <div class="col-12">
                                                <button type="submit" class="btn btn-dark m-auto mt-4">Зарегистрироваться</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
